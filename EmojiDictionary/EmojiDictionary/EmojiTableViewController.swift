...
class EmojiTableViewController: UITableViewController {
    ...
    var emojis: [Emoji] = [
       ...
       description: "A person working on a MacBook (probably using Xcodeto write iOS apps in Swift).", usage: "apps, software, programming"),
...
//        let cell = tableView.dequeueReusableCell(withIdentifier: "reuseIdentifier", for: indexPath)
        let cell = tableView.dequeueReusableCell(withIdentifier:"EmojiCell", for: indexPath) //as !EmojiTableViewController
//         Configure the cell...
